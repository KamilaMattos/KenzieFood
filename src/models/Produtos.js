  ...
  static mostrarProdutos(items) {
    ...
    items.forEach(({ id, imagem, nome, descricao, categoria, preco }) => {
      ...
      imgAddCard.addEventListener("click", (e) => {
        ...
        const calculoPreco =
          e.target.parentElement.childNodes[4].textContent.split(" ")
        ...
        iconeRemover.addEventListener("click", (e) => {
          ...
          if (this.quantidade === 0) {
            ...
            statusCarrinhoVazio.innerText =
              "Seu carrinho está vazio, volte a adicionar produtos no carrinho"
            ul.remove("")
          }
        })
        const categoriaProdutoCarrinho = document.createElement("span")
        categoriaProdutoCarrinho.innerText =
        ...
        precoProdutoCarrinho.innerText =
          e.target.parentElement.childNodes[4].innerText
